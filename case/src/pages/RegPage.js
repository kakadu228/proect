...
export const RegPage = () => {
    ...
    const [form, setForm] = useState({
        email:'', password: '', password_2: '', flag: '1'
    })
            ...
            <div className='valign-wrapper center-align'> 
                <div className='form-1' >
                    ...
                    <div class="custom-control custom-radio">
                        <input onChange={changeHandler} name='flag' type="radio" value='1' id="customRadio1" class="ds custom-control-input"  />
                        <label class="custom-control-label" for="customRadio1">Пользователський</label>
                    </div>

                    <div class="custom-control custom-radio">
                        <input type="radio" id="customRadio2" onChange={changeHandler} value="2" name='flag' class="custom-control-input" />
                        <label class="custom-control-label" for="customRadio2">Соренование</label>
                    </div>
